		...
		recalculated:function(){
			...
			if(this.vScroll){
				if(this.height < H){
					...
					this.vScroll.style.display = this.vScrollOuter.style.display = 'block';
					...
					//如果内容的高度太小
					this.vScroll.style.display = this.vScrollOuter.style.display = 'none';
                    this.range.st = 0;
				};
			};
			if(this.lScroll){
				if(this.width < W){
					...
					this.lScroll.style.display = this.lScrollOuter.style.display = 'block';
					...
					//如果内容的宽度太小
					this.lScroll.style.display = this.lScrollOuter.style.display = 'none';
                    this.range.sl = 0;
				};
			};
		},
